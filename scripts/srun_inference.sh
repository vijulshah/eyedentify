...
srun -K\
    ...
    python /netscratch/$USER/eyedentify/inference_n_interpretation/test_on_dl.py \
        --config_file="/netscratch/$USER/eyedentify/configs/test_on_dl.yml" 